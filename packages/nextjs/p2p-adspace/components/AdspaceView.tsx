...
export const AdspaceView = ({ adspace, onInitiateBid }: AdspaceProps) => {
  ...
  return (
    <div className="flex flex-col w-full bg-base-100 border-base-300 border shadow-md rounded-3xl overflow-hidden">
      <div className="w-full flex items-center justify-center bg-base-300 p-4">
